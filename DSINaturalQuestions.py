...
from evaluation.naturalquestions import EvaluationNaturalQuestions
...
df_query = pickle.load(open("naturalquestionsdataframe(query).pkl", "rb"))
...
def main():
    ...
    log_dir = (
        "./logs/nqlog_t5-small-512_50000_rows_" +
    ...
    args_dict = dict(
        ...
        train_batch_size=32,
        eval_batch_size=32 if not RESUME_CHECKPOINT else 1,
        num_train_epochs=50,
    ...
    evaluator = EvaluationNaturalQuestions(
...
class NQ_IR(pl.LightningModule):
    ...
    def test_dataloader(self):
        ...
        test_dataset = get_dataset(
            ...
            task_type='retrival', num_samples=5499,
